...
Code is open-source MIT at \url{github.com/praxelhq/praxy-tts} (\texttt{evaluation/psp.py}, \texttt{evaluation/psp\_bootstrap.py}, \texttt{evaluation/modal\_psp.py}). Centroids are CC-BY. A submission pipeline and leaderboard run at \url{praxel.ai/psp-leaderboard}.
