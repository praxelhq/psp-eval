...
- ⏳ Formal MOS calibration — deferred to v2 (see `paper/psp/karya_outreach.md`)
...
6. **Calibration study** — 100 utterances × 5 raters × MOS on Prolific (~$500 budget). Tune ANS weights. (~1 week wall-clock.)
